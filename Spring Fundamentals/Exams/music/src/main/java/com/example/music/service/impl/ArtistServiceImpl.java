...
public class ArtistServiceImpl implements ArtistService {
    ...
    public void initializeArtists() {
        ...
        if (artistRepository.count() == 0) {
            Arrays.stream(ArtistNameEnum.values())
                    .forEach(singerNameEnum -> {
                        ArtistEntity artistEntity = new ArtistEntity();
                        artistEntity.setName(singerNameEnum);
                        switch (singerNameEnum) {
                            ...
                            case METALLICA -> artistEntity.setCareerInformation("Metallica is an American heavy metal band. The band was " +
                                    "formed in 1981 in Los Angeles by vocalist/guitarist James Hetfield and drummer Lars Ulrich, and has been " +
                                    "based in San Francisco for most of its career. The band's fast tempos, instrumentals and aggressive " +
                            ...
                            case MADONNA -> artistEntity.setCareerInformation("Madonna Louise Ciccone - born and raised in Michigan, " +
                                    "Madonna moved to New York City in 1978 to pursue a career in modern dance. After performing as a " +
                                    "drummer, guitarist, and vocalist in the rock bands Breakfast Club and Emmy, she rose to solo stardom " +
                                    "with her debut studio album, Madonna (1983). She followed it with a series of successful albums, " +
                                    "including all-time bestsellers Like a Virgin (1984) and True Blue (1986) as well as Grammy Award winners " +
    ...
    @Override
    public ArtistEntity findByArtistNameEnum(ArtistNameEnum artist) {
